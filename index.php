...
if(isset($_SESSION['userid'])){
    ...
    where star_num >= 3.5
    AND (6371 * acos(cos(radians($lat)) * cos(radians(lat)) * cos(radians(lng) - radians($lng)) + sin(radians($lat)) * sin(radians(lat)))) < 10";
    $result = mysqli_query($conn,$sql);
}
?>
<!DOCTYPE html>
...
<html lang="ko">
    ...
    <div class="category_fillter_box container px-2 px-lg-3 mt-6">
            ...
            <div class="filter_box">
              <div class="filter_list">
                <ul>
                  ...
                  <li class="filter_list1">
                    <a href="./joayo/joayo.php?sort=좋아요순">
                      <span>좋아요순</span>
                    </a>
                  </li>
                  <li class="filter_list1">
                    <a href="./views/views.php?sort=조회순">
                      <span>조회순</span>
                    </a>
                  </li>
                  <li class="filter_list1">
                    <a href="./star/star.php?sort=인기순">
                      <span>인기순</span>
                    </a>
                  </li>
                  <li class="filter_list1">
                    <a href="./distance.php?sort=거리순">
                      <span>거리순</span>
                    </a>
                  </li>
                </ul>
