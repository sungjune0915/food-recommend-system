...
FROM food ORDER BY distance ASC";
...
<?php 
    ...
    if( isset($_SESSION['userphnum'])) $userphnum= $_SESSION['userphnum'];
    if( isset($_SESSION['lat'])) $userlat=$_SESSION['lat'];
?>
<html lang="ko">
    <head>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <a class="nav-item dropdown navbar-brand">
            <a style="font-size: 17px; color:black" class="nav-link dropdown-toggle active" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">거리순</a>
