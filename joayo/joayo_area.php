<?php 
 ...
 if( isset($_SESSION['userlevel'])) $userlevel= $_SESSION['userlevel'];
 if( isset($_SESSION['userphnum'])) $userpoint= $_SESSION['userphnum'];
 $sql= "SELECT * FROM food where area_do='$area' ORDER BY like_num DESC";
            ...
            <div class="area_box">
              <div class="area_list">
                <ul>
                  ...
                  <li class="area_list1">
                    <a href="../index_area.php?area=충남&&sort=추천순">
                      <span>충청남도</span>
                    </a>
                  </li>
                  <li class="area_list1">
                    <a href="../index_area.php?area=충북&&sort=추천순">
                      <span>충청북도</span>
                    </a>
                  </li>
                </ul>
            ...
            <div class="filter_box">
              ...
              <ul>
                  <li class="filter_list1">
                    <a href="../index_area.php?area=<?=$area?>&&sort=추천순">
                      <span>추천순</span>
                    </a>
                  </li>
                  <li class="filter_list1">
                  ...
                  <li class="filter_list1">
                    <a href="../star/star_area.php?area=<?=$area?>&&sort=인기순">
                      <span>인기순</span>
                    </a>
                  </li>
                  <li class="filter_list1">
